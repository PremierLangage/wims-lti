...
class WimsClassTestCase(TestCase):
    ...
    def test_wims_class_ok_custom_lti(self):
        ...
        params = {
            ...
            'lis_result_sourcedid':               "14821455",
            'lis_outcome_service_url':            "http://www.outcom.com",
            'custom_class_expiration':            expiration.strftime("%Y%m%d"),
            'oauth_consumer_key':                 KEY,
            'oauth_signature_method':             'HMAC-SHA1',
            'oauth_timestamp':                    str(oauth2.generate_timestamp()),
            'oauth_nonce':                        oauth2.generate_nonce(),
    ...
    def test_wims_class_invalid_custom_lti(self):
        params = {
            'lti_message_type':                   'basic-lti-launch-request',
            'lti_version':                        'LTI-1p0',
            'launch_presentation_locale':         'fr-FR',
            ...
            'lis_result_sourcedid':               "14821455",
            'lis_outcome_service_url':            "http://www.outcom.com",
            'custom_class_expiration':            "20200101",
            'oauth_consumer_key':                 KEY,
            'oauth_signature_method':             'HMAC-SHA1',
            'oauth_timestamp':                    str(oauth2.generate_timestamp()),
            'oauth_nonce':                        oauth2.generate_nonce(),
        ...
        self.assertContains(
            r,
            "Invalid parameter 'custom_class_expiration' ('20200101'): Must be more than a month "
            "and less than a year from now",
            status_code=400
        )
